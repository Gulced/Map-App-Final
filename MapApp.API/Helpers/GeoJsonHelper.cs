...
namespace MapApp.API.Helpers
{
    public static class GeoJsonHelper
    {
        ...
        public static object? ToGeoJson(MapApp.Domain.Entities.Point point)
        {
            if (point == null)
            {
                return null;
        ...
        public static object ToGeoJson(IEnumerable<MapApp.Domain.Entities.Point> points)
        {
